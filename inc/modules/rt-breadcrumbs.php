...
if( ! function_exists( 'docfi_breadcrumbs' )){

	function docfi_breadcrumbs(){
		...
		$home_text  = esc_html__( 'Home', 'docfi' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){
				...
				if ( get_post_type() == 'post' ){
					...
					$category = docfi_get_primary_category_id();
					$category = get_category( $category );
