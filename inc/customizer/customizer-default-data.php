...
if ( ! function_exists( 'rttheme_generate_defaults' ) ) {
    function rttheme_generate_defaults() {
        $customizer_defaults = array(
			...
			'footer_area'				=> 1,
            'nws_shortcode'             => ' ',
            'newsletter_title'           => 'Great Customer Relationships Start Here',
            'copyright_area'            => 1,
            'copyright_menu'            => 1,
            'logo_display'              => 1,
			...
			'team_skill' 				=> 1,
            'team_contact'              => 0,
            'team_contact_title'        => esc_html__('Contact Us', 'docfi'),
			'show_related_team' 		=> 1,
			'team_related_title' 		=> esc_html__('Related Chef', 'docfi'),
            ...
            'single_docs_enddate'    => 1,
            'single_docs_weblink'    => 1,
            'single_docs_rating'     => 1,
            'show_related_docs'      => 0,
