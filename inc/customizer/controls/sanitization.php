...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    /* Footer shape check is enabled */
    if (!function_exists('rttheme_is_footer_newsletter_enabled')) {
        function rttheme_is_footer_newsletter_enabled()
        {
            $footer_newsletter = get_theme_mod('footer_newsletter');
            if (empty($footer_newsletter)) {
                return false;
            }
            return true;
        }
    ...
    /*Blog check is enabled option 2*/
