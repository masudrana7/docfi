...
trait IconTrait {
  ...
  {
    return [
        "icon-docfi-instagram"  => "instagram",
        "icon-docfi-left-arrow"  => "left-arrow",
        "icon-docfi-right-arrow"  => "right-arrow",
        "icon-docfi-location"  => "location",
        "icon-docfi-message"  => "message",
        "icon-docfi-maintain"  => "maintain",
        "icon-docfi-petroleum"  => "petroleum",
        "icon-docfi-quality-control"  => "quality-control",
        "icon-docfi-painter"  => "painter",
        "icon-docfi-pdf"  => "pdf",
        "icon-docfi-phone"  => "phone",
        "icon-docfi-pinterest"  => "pinterest",
        "icon-docfi-play"  => "play",
        "icon-docfi-plus"  => "plus",
        "icon-docfi-power"  => "power",
        "icon-docfi-quote-left"  => "quote-left",
        "icon-docfi-quote-right"  => "quote-right",
        "icon-docfi-rating"  => "rating",
        "icon-docfi-search"  => "search",
        "icon-docfi-select"  => "select",
        "icon-docfi-share"  => "share",
        "icon-docfi-shipping"  => "shipping",
        "icon-docfi-tags"  => "tags",
        "icon-docfi-testing"  => "testing",
        "icon-docfi-time"  => "time",
        "icon-docfi-twitter"  => "twitter",
        "icon-docfi-user"  => "user",
        "icon-docfi-up-arrow"  => "up-arrow",
        "icon-docfi-whatsapp"  => "whatsapp",
        "icon-docfi-worker"  => "worker",
        "icon-docfi-youtube"  => "youtube",
        "icon-docfi-angle-down"  => "angle-down",
        "icon-docfi-angle-left"  => "angle-left",
        "icon-docfi-angle-right"  => "angle-right",
        "icon-docfi-angle-up"  => "angle-up",
        "icon-docfi-architecture"  => "architecture",
        "icon-docfi-automotive"  => "automotive",
        "icon-docfi-calendar"  => "calendar",
        "icon-docfi-calendar-alt"  => "calendar-alt",
        "icon-docfi-cart"  => "cart",
        "icon-docfi-check"  => "check",
        "icon-docfi-comment"  => "comment",
        "icon-docfi-compare"  => "compare",
        "icon-docfi-construction"  => "construction",
        "icon-docfi-docs"  => "docs",
        "icon-docfi-facebook"  => "facebook",
        "icon-docfi-heart" => "heart",
    ];
  }
