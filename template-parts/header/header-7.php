	...
	<div class="container">
		<div class="menu-full-wrap">
			...
			<div class="header-icon-area header-top-icon">
				<?php if ( DocfiTheme::$options['email_icon'] || DocfiTheme::$options['opening_icon'] || DocfiTheme::$options['phone_icon'] ) { ?>
				...
				<?php } ?>
				<?php if ( DocfiTheme::$options['cart_icon'] || DocfiTheme::$options['vertical_menu_icon'] ) { ?>
...
<div class="header-menu header-bottom" id="header-menu">
	<div class="container">
		<div class="menu-full-wrap header-dark">
			...
			<?php if ( DocfiTheme::$options['search_icon'] || DocfiTheme::$options['online_button'] ) { ?>
