...
hljs.registerLanguage("c", (() => {
    "use strict"; return e => {
        const t = (e => {
            function t(e) { return "(?:" + e + ")?" } var n = e.COMMENT("//", "$", {
            ...
            }, m = [o, i, n, e.C_BLOCK_COMMENT_MODE, c, s], p = {
                ...
                disableAutodetect: !0, illegal: "</", contains: [].concat(p, _, m, [o, {
                    begin: "\\b(deque|list|queue|priority_queue|pair|stack|vector|map|set|bitset|multiset|multimap|unordered_map|unordered_set|unordered_multiset|unordered_multimap|array)\\s*<",
                        ...
                        preprocessor: o, strings: s, keywords: u
                    }
            }
        })(e)
...
hljs.registerLanguage("kotlin", (() => {
    "use strict"; return e => {
        const n = {
            ...
            className: "string",
            variants: [{ begin: '"""', end: '"""(?=[^"])', contains: [i, s] }, {
                begin: "'", end: "'",
                illegal: /\n/, contains: [e.BACKSLASH_ESCAPE]
            }, {
                begin: '"', end: '"', illegal: /\n/,
            ...
            name: "Kotlin", aliases: ["kt"], keywords: n, contains: [e.COMMENT("/\\*\\*", "\\*/", {
                ...
                illegal: /fun\s+(<.*>)?[^\s\(]+(\s+[^\s\(]+)\s*=/, relevance: 5, contains: [{
                    ...
                    }, e.C_LINE_COMMENT_MODE, c, l, r, t, e.C_NUMBER_MODE]
                }, c]
            }, {
                className: "class",
...
hljs.registerLanguage("perl", (() => {
    "use strict"; function e(...e) {
        ...
        var t = {
        ...
        }, s = { className: "subst", begin: "[$@]\\{", end: "\\}", keywords: t }, r = {
            begin: /->\{/,
            end: /\}/
        }, i = {
            variants: [{ begin: /\$\d/ }, {
            ...
            className: "string", contains: a, variants: [{
            ...
            }]; return s.contains = o, r.contains = o, {
