	...
	$(document).ready(function () {
	    ...
	    $('#upload_image_btn').click(function(e){
	        ...
	        meta_image_frame.on('select', function(){
				...
				$('.category-image').html(`<div class='category-image-wrap'><img src='${media_attachment.url}' width='200' /><input type="hidden" name="rt_term_image" value='${media_attachment.id}' class="category-image-id"/><button>x</button></div>`); 
	        });
