...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<fieldset class="bbp-form">
		<legend><?php esc_html_e( 'Log In', 'docfi' ); ?></legend>
		...
		<div class="bbp-password">
			<label for="user_pass"><?php esc_html_e( 'Password', 'docfi' ); ?>: </label>
		...
		<div class="bbp-remember-me">
			...
			<label for="rememberme"><?php esc_html_e( 'Keep me signed in', 'docfi' ); ?></label>
		</div>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" name="user-submit" id="user-submit" class="button submit user-submit"><?php esc_html_e( 'Log In', 'docfi' ); ?></button>
